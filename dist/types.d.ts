...
export type CryptoSessionId = string & {
    __brand: "CryptoSessionId";
};
/** Build a {@link CryptoSessionId} from a unique seed. */
export declare function createCryptoSessionId(): CryptoSessionId;
export type Aes128GcmId = "AES-128-GCM" & {
    __brand: "Aes128GcmId";
};
export type Aes256GcmId = "AES-256-GCM" & {
    __brand: "Aes256GcmId";
};
export type Aes128CcmId = "AES-128-CCM" & {
    __brand: "Aes128CcmId";
};
export type ChaCha20Poly1305Id = "ChaCha20-Poly1305" & {
    __brand: "ChaCha20Poly1305Id";
};
/** Every symmetric AEAD cipher this provider supports. */
export type SymmetricCipherId = Aes128GcmId | Aes256GcmId | Aes128CcmId | ChaCha20Poly1305Id;
/** Canonical string literal for each AES-128-GCM usage. */
export declare const AES_128_GCM: Aes128GcmId;
/** Canonical string literal for each AES-256-GCM usage. */
export declare const AES_256_GCM: Aes256GcmId;
/** Canonical string literal for each AES-128-CCM usage. */
export declare const AES_128_CCM: Aes128CcmId;
/** Canonical string literal for each ChaCha20-Poly1305 usage. */
export declare const CHACHA20_POLY1305: ChaCha20Poly1305Id;
export type Sha256Id = "SHA-256" & {
    __brand: "Sha256Id";
};
export type Sha384Id = "SHA-384" & {
    __brand: "Sha384Id";
};
...
export declare const SHA_256: Sha256Id;
/** Canonical string literal for each SHA-384 usage. */
export declare const SHA_384: Sha384Id;
export type X25519Id = "X25519" & {
    __brand: "X25519Id";
};
...
export declare const X25519: X25519Id;
/**
...
export interface AeadCipher {
     ...
     */
    readonly encrypt: (key: Uint8Array, nonce: Uint8Array, plaintext: Uint8Array, aad: Uint8Array) => Uint8Array;
    /**
     * Decrypt `ciphertext` (with appended tag) under `key`/`nonce`, verifying `aad`.
     * Throws {@link DecryptError} on authentication failure.
     */
    readonly decrypt: (key: Uint8Array, nonce: Uint8Array, ciphertext: Uint8Array, aad: Uint8Array) => Uint8Array;
}
