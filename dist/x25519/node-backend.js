 ...
 */
import { diffieHellman, createPrivateKey, createPublicKey, generateKeyPairSync, } from "node:crypto";
// ---------------------------------------------------------------------------
 ...
 */
const PKCS8_PREFIX = new Uint8Array(Buffer.from("302e020100300506032b656e04220420", "hex"));
/**
 ...
 */
const SPKI_PREFIX = new Uint8Array(Buffer.from("302a300506032b656e032100", "hex"));
/** Wrap a raw 32-byte X25519 private scalar as a PKCS#8 DER blob. */
function rawPrivateToPkcs8(priv) {
...
// ---------------------------------------------------------------------------
export class NodeX25519Backend {
    sharedSecret(priv, pub) {
        try {
